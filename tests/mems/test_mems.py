"""
Pytest function for mems/mems.py.
"""
import pytest
import jax
...
from models_x.mems.mems import MeMs
...
def test_mems(nblocks, attn_implementation, dtype):
    """
    Pytest mems.MeMs.
    """
    # Start
    ...
    # Get mdl
    mdl = MeMs.from_config(cfg=cfg)
    assert isinstance(mdl, MeMs)
    assert callable(mdl)
