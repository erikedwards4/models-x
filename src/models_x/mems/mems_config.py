"""
Config for the Memory Mosaics model using JAX.
...
class MeMsConfig():
    ...
    n_positions: int = field(default=512, metadata=metadata)
    ...
    def d_head(self: Self) -> int:
        """Sets d_head for the MeMsDecoderBlockAtten."""
    ...
    def scale(self: Self) -> float:
        """Sets scale for the MeMsDecoderBlockAtten."""
